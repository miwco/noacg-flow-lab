...
9. Use **Step back** to restore the exact state and variables before the most recent event, or Reset to begin again.
10. Export normalized v2 JSON or a standalone HTML player. Invalid projects cannot be exported or simulated.
11. Load **Lower third** to confirm the same runtime contract supports a different graphic and control panel.
